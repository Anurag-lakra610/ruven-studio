...
('w1111111-1111-1111-1111-111111111111', 'South India Fulfillment Center', '{"street": "12/A Textile Park", "city": "Tiruppur", "state": "Tamil Nadu", "zip": "641601", "country": "India"}', TRUE);
...
('p1111111-1111-1111-1111-111111111112', 'c1111111-1111-1111-1111-111111111113', 'Renewal of Mind French Terry Hoodie', 'renewal-of-mind-french-terry-hoodie', '380 GSM ultra-heavy French Terry hoodie. Features a relaxed boxy silhouette, loop-back lining, and embroidered Romans 12:2 details on the chest.', 3499.00, 'Published', 'Renewal of Mind French Terry Hoodie — Ruven Studio', 'Cozy 380 GSM combed French Terry hoodie with embroidered Romans 12:2 scripture details.');

-- 6. Seed Product Variants
INSERT INTO product_variants (id, product_id, sku, size, color, weight_grams, cost_price) VALUES
('v1111111-1111-1111-1111-111111111111', 'p1111111-1111-1111-1111-111111111111', 'RU-OVS-GRC-S', 'S', 'Ink Black', 240, 800.00),
('v1111111-1111-1111-1111-111111111112', 'p1111111-1111-1111-1111-111111111111', 'RU-OVS-GRC-M', 'M', 'Ink Black', 240, 800.00),
('v1111111-1111-1111-1111-111111111113', 'p1111111-1111-1111-1111-111111111111', 'RU-OVS-GRC-L', 'L', 'Ink Black', 240, 800.00),
('v1111111-1111-1111-1111-111111111114', 'p1111111-1111-1111-1111-111111111111', 'RU-OVS-GRC-XL', 'XL', 'Ink Black', 240, 800.00),
('v1111111-1111-1111-1111-111111111115', 'p1111111-1111-1111-1111-111111111112', 'RU-HD-RNW-M', 'M', 'Warm Charcoal', 380, 1400.00),
('v1111111-1111-1111-1111-111111111116', 'p1111111-1111-1111-1111-111111111112', 'RU-HD-RNW-L', 'L', 'Warm Charcoal', 380, 1400.00),
('v1111111-1111-1111-1111-111111111117', 'p1111111-1111-1111-1111-111111111112', 'RU-HD-RNW-XL', 'XL', 'Warm Charcoal', 380, 1400.00);

-- 7. Seed Inventory Stock
INSERT INTO inventory (variant_id, warehouse_id, quantity, low_stock_threshold, bin_location) VALUES
('v1111111-1111-1111-1111-111111111111', 'w1111111-1111-1111-1111-111111111111', 120, 5, 'A-01-1'),
('v1111111-1111-1111-1111-111111111112', 'w1111111-1111-1111-1111-111111111111', 150, 5, 'A-01-2'),
('v1111111-1111-1111-1111-111111111113', 'w1111111-1111-1111-1111-111111111111', 180, 5, 'A-01-3'),
('v1111111-1111-1111-1111-111111111114', 'w1111111-1111-1111-1111-111111111111', 90, 5, 'A-01-4'),
('v1111111-1111-1111-1111-111111111115', 'w1111111-1111-1111-1111-111111111111', 75, 5, 'B-04-1'),
('v1111111-1111-1111-1111-111111111116', 'w1111111-1111-1111-1111-111111111111', 80, 5, 'B-04-2'),
('v1111111-1111-1111-1111-111111111117', 'w1111111-1111-1111-1111-111111111111', 45, 5, 'B-04-3');

-- 8. Seed Scriptures
INSERT INTO scriptures (id, book, chapter, verse, translation, text_content) VALUES
('s1111111-1111-1111-1111-111111111111', 'Romans', 13, '12', 'ESV', 'The night is far gone; the day is at hand. So then let us cast off the works of darkness and put on the armor of light.'),
('s1111111-1111-1111-1111-111111111112', 'Romans', 12, '2', 'ESV', 'Do not be conformed to this world, but be transformed by the renewal of your mind, that by testing you may discern what is the will of God, what is good and acceptable and perfect.');
