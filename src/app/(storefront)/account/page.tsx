      ...
      <div className="max-w-[1200px] mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-border-warm">
          <div className="space-y-1">
            <span className="text-[10px] font-bold tracking-[0.15em] text-brand-gold uppercase block">Customer Dashboard</span>
          ...
          <button
            ...
            className="px-5 py-2 border border-border-warm hover:bg-bg-card rounded-full text-xs font-bold uppercase tracking-wider text-text-primary flex items-center gap-1.5 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Left profile info */}
          <div className="lg:col-span-4 bg-white dark:bg-zinc-900 border border-border-warm rounded-xl p-6 space-y-6">
          ...
          {/* Right order list */}
          <div className="lg:col-span-8 bg-white dark:bg-zinc-900 border border-border-warm rounded-xl p-6 space-y-6">
            <h3 className="text-xs font-bold uppercase tracking-wider text-text-primary pb-3 border-b border-border-warm">
                  ...
                  <div key={ord.number} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 py-4 first:pt-0 last:pb-0">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2 text-xs">
                        ...
                        <span className="text-[9px] px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider bg-zinc-100 dark:bg-zinc-800 text-text-muted">
                          {ord.status}
                        </span>
                      </div>
                    ...
                    <div className="flex sm:flex-col items-baseline sm:items-end justify-between w-full sm:w-auto gap-4">
                      ...
                      <Link
                        ...
                        className="text-[10px] font-bold uppercase tracking-widest text-brand-gold hover:text-brand-burgundy transition-colors flex items-center gap-1"
                      >
