...
function ConfirmationContent() {
  ...
  return (
    <div className="w-full bg-bg-warm dark:bg-zinc-950 py-20 px-6 text-center flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-white dark:bg-zinc-900 border border-border-warm rounded-xl p-8 md:p-10 shadow-md space-y-6">
        <div className="w-16 h-16 rounded-full bg-green-50 dark:bg-green-950/30 text-green-600 dark:text-green-500 flex items-center justify-center mx-auto shadow-sm">
          <CheckCircle2 className="w-10 h-10" />
        </div>

        <div className="space-y-2">
          <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-gold">Order Placed Successfully</span>
        ...
        <div className="bg-bg-card dark:bg-zinc-950 p-4 rounded-lg border border-border-warm space-y-1.5 text-xs text-text-primary">
        ...
        <div className="text-left text-xs bg-bg-warm dark:bg-zinc-950/50 p-5 rounded-lg border border-border-warm space-y-3">
        ...
        <div className="flex flex-col gap-3 pt-4">
          <Link
            ...
            className="w-full py-3 bg-brand-burgundy hover:bg-brand-gold text-white text-xs font-bold uppercase tracking-widest rounded-full transition-colors flex items-center justify-center gap-2"
          >
          ...
          <Link
            href="/shop"
            className="w-full py-3 bg-transparent border border-border-warm hover:bg-bg-card text-text-primary text-xs font-bold uppercase tracking-widest rounded-full transition-colors flex items-center justify-center gap-2"
          >
